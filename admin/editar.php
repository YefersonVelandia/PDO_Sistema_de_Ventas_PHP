	...
	<div class="row">
		<div class="col-lg-12">
			...
			<form method="post" action="guardarDatosEditados.php">
				...
				<input disabled value="<?php echo $producto->precioVenta ?>" class="form-control" name="precioVenta" required type="number" id="precioVenta" placeholder="Precio de venta">
